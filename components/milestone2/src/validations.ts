...
export function validateLocation(location: BrasalandLocation): ValidationResult {
  const errors: string[] = [];
...
export function validateLocationPortfolio(locations: BrasalandLocation[]): ValidationResult {
  const errors: string[] = [];
  ...
  const colombiaCount = locations.filter((location: BrasalandLocation): boolean => location.countryMarket === "Colombia").length;
  const floridaCount = locations.filter((location: BrasalandLocation): boolean => location.countryMarket === "United States (Florida)").length;
...
export function validateSaleRecord(sale: SaleRecord): ValidationResult {
  const errors: string[] = [];
...
export function validateEmployeeRecord(employee: EmployeeRecord): ValidationResult {
  const errors: string[] = [];
...
export function validateEmployeeHeadcount(employees: EmployeeRecord[]): ValidationResult {
  const errors: string[] = [];
...
export function validateAutomationRequest(request: AutomationRequest): ValidationResult {
  const errors: string[] = [];
